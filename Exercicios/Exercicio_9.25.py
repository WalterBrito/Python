...
"""
Modifique o programa de forma a poder registrar vários telefones
para a mesma pesssoa. Permita também cadastrar o tipo de telefone: 
celular, fixo, residência, trabalho ou fax.
"""
...
def novo():
     ...
     telefones = []
     while True:
        número = pede_telefone()
        tipo = pede_tipo_telefone()
        if confirma("Deseja cadastrar outro número? ") == "N":
            break 
     email = pede_email()
